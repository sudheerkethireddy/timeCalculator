...
public class TimeCalculatorTest {
    ...
    @Test(expected = NullEmptyCheckException.class)
    public void testForNullTimeInput() throws NullEmptyCheckException, TimeFormatException {
    ...
    @Test(expected = NullEmptyCheckException.class)
    public void testForEmptyTimeInput() throws NullEmptyCheckException, TimeFormatException {
    ...
    public void testForWrongTimeInput() throws NullEmptyCheckException, TimeFormatException {
    ...
    @Test
    public void testForZeroMinutesAdded() throws NullEmptyCheckException, TimeFormatException {
    ...
    @Test
    public void testForPositiveMinutesAdded() throws NullEmptyCheckException, TimeFormatException {
    ...
    @Test
    public void testForNegativeMinutesAdded() throws NullEmptyCheckException, TimeFormatException {
    ...
    @Test
    public void testForMinutesEqualToDayAdded() throws NullEmptyCheckException, TimeFormatException {
    ...
    @Test
    public void testForMinutesGreaterThanDayAdded() throws NullEmptyCheckException, TimeFormatException {
    ...
    @Test
    public void testForMinutesAddedThatChangeMeridianFromAMtoPM() throws NullEmptyCheckException, TimeFormatException {
    ...
    @Test
    public void testForMinutesAddedThatChangeMeridianFromPMtoAM() throws NullEmptyCheckException, TimeFormatException {
    ...
    /* this test covers sceanrio where when we add minutes to the input time it changes from PM to AM.*/
    @Test
    public void testForMinutesAddedThatChangeHourButNotMeridian() throws NullEmptyCheckException, TimeFormatException {
